        ...
        <div className="text-center space-y-8">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-6">
              <a
                ...
                className="flex items-center gap-2 text-white hover:text-[#12deba] transition-colors"
              >
                <span>📧</span>
                <span>hello@jerelle.co</span>
              </a>
              <a
                href="tel:3065151774"
                className="flex items-center gap-2 text-white hover:text-[#12deba] transition-colors"
          ...
          >
            <p className="text-white/40 text-sm">
              Serving Lethbridge & Southern Alberta
            </p>

            {/* Social & Main site links */}
            <div className="flex items-center justify-center gap-6">
              <a
                href="https://jerelle.co"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/40 hover:text-[#12deba] transition-colors text-sm"
              >
                Main Site
              </a>
              <a
